...
const AboutCard = () => {
  ...
  return (
    <div className="bg-[#363C43]  w-[720px] h-[316px] rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] relative">
      ...
      <div className="h-full flex flex-col justify-center items-center mx-12 gap-10">
        <div  ref={buttonContainerRef} className="bg-[#171717] text-[#969696] w-full h-16 rounded-3xl flex justify-evenly items-center text-lg font-semibold ">
          
          {["About Me", "Experiences", "Recommended"].map((label, index) => (
            <button
              key={index}
              className={`relative overflow-hidden text-[#969696] w-full py-3 mx-2 rounded-2xl ${
           ...
           <div
            className="absolute top-4 left-0 h-12 mt-2 rounded-2xl shadow-[0_20px_50px_rgba(0,_0,_0,_0.7)]  bg-[#3c414a] transition-transform duration-500"
            style={{
        ...
        <div>
          <p className=" text-[#969696] text-[20px]">
