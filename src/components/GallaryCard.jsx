...
const GallaryCard = () => {
  ...
  const handleClickRight = () => {
    if (currentIndex < images.length - 3) { // Adjust condition based on the number of visible images
      setIsActive2(true);
      setCurrentIndex((prevIndex) => prevIndex + 1);
      setTimeout(() => {
        setIsActive2(false);
  ...
  return (
    <div>
      <div className="bg-[#363C43] w-[720px] h-[330px] rounded-[18.89px] shadow-[5.67px_5.67px_3.78px_0px_rgba(0,0,0,0.4)] relative">
